...
<style>
:root {
   --icon--size--lgscreen: 30px;
   --icon--size--smallscreen: 40px;
}
...
.cursor-mode--icon {
   position: absolute;
   top: calc(50% - --icon--size--lgscreen / 2);
   left: calc(50% - --icon--size--lgscreen / 2);
   ;
   width: var(--icon--size--lgscreen);
   height: var(--icon--size--lgscreen);
}

@media screen and (max-width: 1024px) {
   .cursor-mode--icon {
      width: var(--icon--size--smallscreen);
      height: var(--icon--size--smallscreen);
   }

}

.cursor-mode--icon.icon-moon {
   fill: var(--main-color);
}

.cursor-mode--icon.icon-sun {
   stroke: var(--main-color);
   display: none;
}

.cursor-mode--input:checked~.cursor-mode--icon.icon-sun {
   display: block;
}

.cursor-mode--input:checked~.cursor-mode--icon.icon-moon {
   display: none;
}
