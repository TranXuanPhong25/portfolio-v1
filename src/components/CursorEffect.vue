...
<template>
   <label class="theme">
      <input type="checkbox" :checked="dustTrailMode" class="input" @click="toggleCursorEffect">
      <svg class="icon icon-sun" aria-hidden="true" viewBox="-3 -3 30 30">
         <path
      ...
      <svg class="icon icon-moon" aria-hidden="true" viewBox="-35.84 -35.84 583.68 583.68">
         <path
